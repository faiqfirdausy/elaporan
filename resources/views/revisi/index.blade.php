@extends('layouts.apps', ['title' => 'Daftar Revisi'])
	                ...
	                <thead>
	              	...
	              	<tbody>
	              		...
	              		<tr>
	              			...
	              			<td>{{$bulanan->path}}</td>
	              			<td><a href="{{url('laporan/bulanan/ubah/'.$bulanan->id_transaksi.'')}}" class="btn btn-sm btn-warning btn-flat">Revisi</a> <!-- <button type="button" class="btn btn-sm btn-danger btn-flat" data-toggle="modal" data-target="#modal-warning">Hapus</button></td> -->
	              		</tr>
	              		@endforeach
	              	</tbody>
          		</table>
