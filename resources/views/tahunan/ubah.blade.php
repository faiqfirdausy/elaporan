@extends('layouts.apps', ['title' => 'Ubah Laporan Tahunan'])

@section('content')
  <section class="content-header">
    <h1>
      Ubah Laporan Tahunan
    </h1>
  </section>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box box-primary">
            ...
            <form action="{{url('laporan/tahunan/unggah/update')}}" method="POST" role="form" enctype="multipart/form-data">
              {!! csrf_field() !!}
              <div class="box-body">
